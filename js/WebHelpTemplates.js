...
WebHelpTemplates["WebHelpContent"] = "<div id=\"contentConsumptionModal\" class=\"modal\" onClick=\"if(event.target!== this) return; WebHelp.onSequenceClose();\">\n" +
   "	<div class=\"modal-dialog\">\n" +
   "		<div class=\"modal-content\">\n" +
   "			<div class=\"modal-header ai-modal-title\">\n" +
   "				<button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\" onclick=\"WebHelp.onSequenceClose();\"><span aria-hidden=\"true\">&times;</span>\n" +
   "				</button>\n" +
   ...
   "				<button data-dismiss=\"modal\" class=\"btn btn-warning\" onclick=\"WebHelp.onSequenceClose();\">Close</button>\n" +
   "			</div>\n" +
   "		</div>\n" +
   "	</div>\n" +
   "</div>\n" +
